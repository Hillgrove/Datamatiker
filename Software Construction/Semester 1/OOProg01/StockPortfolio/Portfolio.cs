...
public class Portfolio
{
    ...
    public double TotalEarningsPercentage
    {
        get
        {
            ...
            double initialTotal = _stock1.InitialPrice * _stock1.Amount +
                                  _stock2.InitialPrice * _stock2.Amount +
                                  _stock3.InitialPrice * _stock3.Amount;

            double currentTotal = _stock1.CurrentPrice * _stock1.Amount +
                                  _stock2.CurrentPrice * _stock2.Amount +
                                  _stock3.CurrentPrice * _stock3.Amount;

            double earnings = currentTotal - initialTotal;
            return (earnings / initialTotal) * 100;
        }
    }
    #endregion
