...
public class StudentRepository
{
    ...
    public double? TotalAverage
    {
        get
        {
            var averages = from student in _students.Values
                           where student.ScoreAverage.HasValue
                           select student.ScoreAverage.Value;
            
            return averages.Any() ? averages.Average() : null;
        }
    }
    #endregion
